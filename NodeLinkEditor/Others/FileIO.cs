...
namespace NodeLinkEditor.Others
{
    public class FileIO
    {
        ...
        public static void SaveNodeLinkToJson(string filePath, MapData mapData, ObservableCollection<NodeViewModel> nodes, ObservableCollection<LinkViewModel> links)
        {
        ...
        public static (MapData, ObservableCollection<NodeViewModel>, ObservableCollection<LinkViewModel>) LoadNodeLinkFromJson(string filePath)
        {
            ...
            {
                return (new MapData(), nodes, links);
            }
            var mapData = LoadMapFromYaml(data.YamlFileName);
            return (mapData, nodes, links);
        }
